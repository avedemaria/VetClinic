...
import com.example.vetclinic.presentation.mainScreen.homeScreen.profileFragment.petFragment.addPetFragment.AddPetViewModel
import com.example.vetclinic.presentation.adminScreen.AdminHomeViewModel
import com.example.vetclinic.presentation.mainScreen.homeScreen.doctorsListFragment.bookAppointmentFragment.BookAppointmentViewModel
import com.example.vetclinic.presentation.mainScreen.homeScreen.doctorsListFragment.DoctorViewModel
...
import com.example.vetclinic.presentation.mainScreen.homeScreen.profileFragment.petFragment.PetViewModel
import com.example.vetclinic.presentation.mainScreen.homeScreen.doctorsListFragment.plainServicesListFragment.PlainServiceViewModel
import com.example.vetclinic.presentation.loginScreen.registrationFragment.RegistrationViewModel
...
import com.example.vetclinic.presentation.mainScreen.homeScreen.profileFragment.userFragment.settingsFragment.SettingsViewModel
import com.example.vetclinic.presentation.appointmentsScreen.SharedAppointmentsViewModel
import com.example.vetclinic.presentation.mainScreen.homeScreen.doctorsListFragment.detailedDoctorInfoFragment.DetailedDoctorInfoViewModel
import com.example.vetclinic.presentation.mainScreen.homeScreen.profileFragment.userFragment.UserViewModel
